#ifndef RDC_SDDS_BASE_IMPL_BASE_H
#define RDC_SDDS_BASE_IMPL_BASE_H
...
class RDC_SDDS_base : public frontend::FrontendTunerDevice<frontend_tuner_status_struct_struct>, public virtual frontend::digital_tuner_delegation, public virtual frontend::rfinfo_delegation, protected ThreadedComponent, public virtual DynamicComponent
{
    public:
        RDC_SDDS_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl);
        RDC_SDDS_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev);
        RDC_SDDS_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities);
        RDC_SDDS_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev);
        ~RDC_SDDS_base();
...
#endif // RDC_SDDS_BASE_IMPL_BASE_H
