#ifndef RDC_SDDS_I_IMPL_H
#define RDC_SDDS_I_IMPL_H

#include "RDC_SDDS_base.h"

class RDC_SDDS_i : public RDC_SDDS_base
{
    ENABLE_LOGGING
    public:
        RDC_SDDS_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl);
        RDC_SDDS_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev);
        RDC_SDDS_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities);
        RDC_SDDS_i(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev);
        ~RDC_SDDS_i();
